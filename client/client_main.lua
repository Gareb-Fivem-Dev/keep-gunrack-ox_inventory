...
local function open_stash(plate)
     ...
     exports.ox_inventory:openInventory('stash', {
          id = Config.gunrack.stash_prefix .. plate,
 
          -- owner = CID
      })
    -- exports.ox_inventory:openInventory('stash', {id=plate})
--     TriggerServerEvent("inventory:server:OpenInventory", "stash", Config.gunrack.stash_prefix .. plate, settings)
--     exports.ox_inventory:openInventory('stash', Config.gunrack.stash_prefix .. plate, settings)
     --exports.ox_inventory:openInventory('stash', { id=Config.gunrack.stash_prefix .. plate, slots='70', weight='70000' })
     -- TriggerServerEvent("inventory:server:OpenInventory", "stash", Config.gunrack.stash_prefix .. plate, slots = "70", weight = "70000",)
